...
|---|---|
| ![dashboard](docs/assets/dash.png) | ![memory](docs/assets/memory.png) |

| Memory detail | Statistics |
|---|---|
| ![detail](docs/assets/detail.png) | ![stats](docs/assets/stats.png) |

### In action

**Panel tour — dashboard, trends, browsing, detail:**

![tour](docs/assets/tour.gif)

**Issue a per-person token, revoke it — effective immediately, no restart:**

![tokens](docs/assets/tokens.gif)
